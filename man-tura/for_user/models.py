...
class RestaurantInfo(models.Model):
    ...
    rest_phone_number = models.CharField(verbose_name='Номер телефону ресторану',max_length=15)
    ...
    wifi_password = models.CharField(verbose_name='Пароль Wi-Fi', max_length=255,default='-')
